...
public class Projecto {
    ...
    public Projecto() {
        this.facadeDAO=JmdiMain.facadeBL.getFacadeDAO();        
    }
    ...
    public List<Fase> getFases() throws PersistableException {
        List<Fase> ret = new ArrayList();

        
        for(Object obj : JmdiMain.facadeBL.getAll(new Fase(), "Projecto_Id", String.valueOf(this.Id))) {
            Fase f = (Fase)obj;
            ret.add(f);
        }
        return ret;
    }
    public List<Tarefa> getTarefas(Fase f) throws PersistableException {
        List<Tarefa> ret = new ArrayList();
        for(Object obj : JmdiMain.facadeBL.getAll(new Tarefa(), "Id", String.valueOf(f.getId()))) {
            Tarefa t = (Tarefa)obj;
            ret.add(t);
        }
        return ret;
    ...
    public void adicionarFase(Fase f) throws PersistableException {
        JmdiMain.facadeBL.put(f);
    }
    
    public void adicionarTarefa(Tarefa t) throws PersistableException {
        JmdiMain.facadeBL.put(t);
    }
    ...
    public List<Tarefa> getTarefasIniciadas (int Projecto_Id) throws PersistableException {
        ...
        for( Fase f : this.getFases()) {
            for ( Tarefa t : this.getTarefas(f)) {
    ...
    public void iniciarTarefa(int Tarefa_Id, Date dt_inicio) throws PersistableException {
         JmdiMain.facadeBL.update(GesHabitat.getType(new Tarefa()),"Data_inicio", dt_inicio.toString(), Tarefa_Id);
    }
    ...
    public Object[] getRowData() {
        ...
        if(DtConclusaoProjecto!=null) Estado="Concluido";
        Object[] ret = {Id,Descricao,Localidade,DtInicioProjecto,DtConclusaoProjecto,Estado};
        return ret;
    }
